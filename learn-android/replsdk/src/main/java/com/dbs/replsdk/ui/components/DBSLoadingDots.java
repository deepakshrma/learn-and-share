 ...
 */
public class DBSLoadingDots extends LinearLayout {
    ...
    public DBSLoadingDots(Context context) {
        super(context);
        init(null);
    }

    public DBSLoadingDots(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs);
    }

    public DBSLoadingDots(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(attrs);
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public DBSLoadingDots(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    private void init(AttributeSet attrs) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.DBSLoadingDots);

        mAutoPlay = a.getBoolean(R.styleable.DBSLoadingDots_dbs_auto_play, true);

        mDotsColor = a.getColor(R.styleable.DBSLoadingDots_dbs_dots_color, Color.GRAY);
        mDotsCount = a.getInt(R.styleable.DBSLoadingDots_dbs_dots_count, DEFAULT_DOTS_COUNT);
        mDotSize = a.getDimensionPixelSize(R.styleable.DBSLoadingDots_dbs_dots_size,
                resources.getDimensionPixelSize(R.dimen.dbs_dots_size_default));
        mDotSpace = a.getDimensionPixelSize(R.styleable.DBSLoadingDots_dbs_dots_space,
                resources.getDimensionPixelSize(R.dimen.dbs_dots_space_default));

        mLoopDuration = a.getInt(R.styleable.DBSLoadingDots_dbs_loop_duration, DEFAULT_LOOP_DURATION);
        mLoopStartDelay = a.getInt(R.styleable.DBSLoadingDots_dbs_loop_start_delay, DEFAULT_LOOP_START_DELAY);

        mJumpDuration = a.getInt(R.styleable.DBSLoadingDots_dbs_jump_duration, DEFAULT_JUMP_DURATION);
        mJumpHeight = a.getDimensionPixelSize(R.styleable.DBSLoadingDots_dbs_jump_height,
                resources.getDimensionPixelSize(R.dimen.dbs_jump_height_default));
